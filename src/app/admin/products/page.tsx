...
import { Plus, Save, Image as ImageIcon, Link as LinkIcon, Package, FolderOpen, Trash2, Edit2, X, Sparkles, FileText, List, Files, Target, ChevronDown, ChevronUp } from "lucide-react";
                      ...
                      <div className="flex items-center gap-4">
                        <div className="relative shrink-0">
                          ...
                          <label 
                            ...
                            className={`flex items-center justify-center w-20 h-20 rounded-xl cursor-pointer transition-all border overflow-hidden ${imageFiles[0] || imageUrls[0] ? 'border-primary shadow-[0_0_15px_rgba(197,165,114,0.3)]' : 'bg-white/5 text-zinc-500 border-white/10 hover:border-primary/30 hover:bg-primary/5'}`}
                          >
                        ...
                        <div className="flex items-center gap-4">
                          <div className="relative shrink-0">
                            ...
                            <label 
                              ...
                              className={`flex items-center justify-center w-20 h-20 rounded-xl cursor-pointer transition-all border overflow-hidden ${imageFiles[index] || imageUrls[index] ? 'border-primary shadow-[0_0_15px_rgba(197,165,114,0.3)]' : 'bg-white/5 text-zinc-500 border-white/10 hover:border-primary/30 hover:bg-primary/5'}`}
                            >
                    ...
                    <tr key={product.id} className="hover:bg-white/[0.02] transition-colors group">
                      <td className="p-10">
                        <div className="flex items-center gap-8">
                          <div className="w-20 h-20 rounded-[1.2rem] overflow-hidden border border-white/10 group-hover:border-primary/50 transition-all shadow-2xl relative shrink-0">
                            <img 
