            ...
            >
              ...
              <div className="space-y-6 mb-10">
                <button
                  type="button"
                  onClick={() => googleLogin()}
                  className="w-full bg-white text-black py-4 rounded-2xl font-black text-sm transition-all shadow-xl flex items-center justify-center gap-4 uppercase tracking-widest hover:bg-zinc-200 active:scale-95"
                >
