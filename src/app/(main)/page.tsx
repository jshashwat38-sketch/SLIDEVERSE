            ...
            {(reviews.length > 0 ? reviews : [
              ...
              >
                ...
                <p className="text-zinc-300 text-lg leading-relaxed font-medium italic mb-10">
                  "{typeof testimonial.text === 'object' && testimonial.text !== null ? ((testimonial.text as any)[language] || (testimonial.text as any).en || "") : (testimonial.text || "")}"
                </p>
                <div className="border-t border-white/5 pt-8">
                  <div className="text-white font-bold text-sm uppercase tracking-widest">
                    {typeof testimonial.name === 'object' && testimonial.name !== null ? ((testimonial.name as any)[language] || (testimonial.name as any).en || "") : (testimonial.name || "")}
                  </div>
                  <div className="text-primary text-[9px] font-bold uppercase tracking-[0.3em] mt-1">
                    {typeof testimonial.role === 'object' && testimonial.role !== null ? ((testimonial.role as any)[language] || (testimonial.role as any).en || "") : (testimonial.role || "")}
                  </div>
                </div>
              </motion.div>
            ))}
