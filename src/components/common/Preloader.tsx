  ...
  useEffect(() => {
    async function loadLogo() {
      try {
        ...
        console.error("Failed to load preloader logo:", error);
      }
    }
    loadLogo();
  }, []);
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/90 backdrop-blur-xl">
      <div className="relative">
        ...
        <motion.div
          ...
          className="relative w-32 h-32 flex items-center justify-center bg-black rounded-3xl border border-primary/20 shadow-[0_0_50px_rgba(197,165,114,0.3)] overflow-hidden"
        >
          <Image
            src={logo}
            alt="Slideverse Logo"
