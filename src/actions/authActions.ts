  ...
  try {
    ...
    try {
      ...
      const info = await transporter.sendMail({
        ...
        html: `
          <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #001233; padding: 60px 20px; text-align: center;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #001A4D; border: 1px solid #0033CC; border-radius: 40px; padding: 50px; box-shadow: 0 20px 50px rgba(0,0,0,0.5);">
              <div style="margin-bottom: 40px;">
                ...
                <p style="color: #0052FF; font-size: 10px; font-weight: 900; letter-spacing: 3px; text-transform: uppercase; margin-top: 10px;">Secure Identity Protocol</p>
              </div>
              ...
              <p style="color: #A3C2FF; font-size: 14px; line-height: 1.6; margin-bottom: 40px;">Initiating authorization sequence for your operative account. Enter the following 6-digit code to establish identity.</p>
              <div style="background-color: rgba(212,255,0,0.1); border: 2px solid #D4FF00; border-radius: 20px; padding: 30px; display: inline-block; min-width: 200px;">
                <span style="font-size: 48px; font-weight: 900; color: #D4FF00; letter-spacing: 10px; font-family: monospace;">${otp}</span>
              </div>
              <p style="color: #0052FF; font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: 2px; margin-top: 40px;">This sequence will expire in 10 minutes.</p>
              <div style="margin-top: 50px; border-top: 1px solid #0033CC; padding-top: 30px;">
                <p style="color: #5C8AFF; font-size: 10px; margin-top: 30px;">If you did not initiate this protocol, ignore this broadcast.</p>
              </div>
            </div>
          </div>
        `,
