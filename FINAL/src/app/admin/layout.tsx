...
import { LayoutDashboard, Package, Users, LogOut, Settings, Lock, Sparkles } from "lucide-react";
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-4 px-6 py-4 rounded-xl transition-all ${
                  isActive 
                    ? "bg-primary/10 text-primary font-black shadow-[0_0_15px_rgba(212,255,0,0.15)] border border-primary/20" 
