      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="flex gap-6">
          <div className="bg-card px-6 py-3 rounded-2xl border border-white/5 shadow-lg flex items-center gap-4 text-xs font-black uppercase tracking-widest">
            <span className="w-2.5 h-2.5 rounded-full bg-primary animate-pulse shadow-[0_0_8px_rgba(212,255,0,0.8)]"></span>
              ...
              {orders.map((order) => (
                <tr key={order.id} className="hover:bg-white/5 transition-colors group">
                  <td className="p-8">
                    ...
                    <div className="text-zinc-600 text-[10px] font-bold uppercase tracking-widest mt-1 flex items-center gap-2">
                  ...
                  <td className="p-8">
                    {order.status === 'pending' && (
                      <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-primary/10 text-primary border border-primary/20 shadow-[0_0_10px_rgba(212,255,0,0.1)]">
