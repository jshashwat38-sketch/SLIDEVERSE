            ...
            <div className="grid grid-cols-6 gap-4">
              {allImages.map((img: string, i: number) => (
                <button
                  key={i}
                  onClick={() => setActiveImage(i)}
                  className={`aspect-square rounded-2xl overflow-hidden border-2 transition-all ${activeImage === i ? 'border-primary shadow-[0_0_15px_rgba(212,255,0,0.3)]' : 'border-white/5 hover:border-white/20'}`}
                >
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-6 mt-auto">
              <button 
                ...
                className="flex-1 bg-primary hover:bg-primary-hover text-black px-10 py-6 rounded-3xl font-black text-xl transition-all shadow-[0_0_30px_rgba(212,255,0,0.2)] hover:shadow-[0_0_50px_rgba(212,255,0,0.4)] hover:-translate-y-1 uppercase tracking-widest italic"
              >
                Acquire Asset
              </button>
              <button 
